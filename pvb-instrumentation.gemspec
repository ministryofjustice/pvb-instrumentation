...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Provide instrumentation for HTTP Clients used in prison visit booking applications}
  spec.description   = %q{Provide instrumentation for HTTP Clients (Excon and Faraday) used in prison visit booking applications}
